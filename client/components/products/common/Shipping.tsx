import { ProductShipping, ShippingMethod } from "@/interfaces";
import {
  faBolt,
  faCalendarCheck,
  faClockRotateLeft,
...
export default function Shipping({
  ...
  return (
    <div className="text-sm text-(--text) max-w-[500px]">
      <div className={`gap-3 ${forElement === "detail" ? "grid grid-cols-4" : "flex"}`}>
        {methods.map((method) => (
