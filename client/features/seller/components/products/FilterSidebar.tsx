...
export default function FilterSidebar() {
  ...
  const selectClass =
    "w-full appearance-none bg-white border border-gray-200 text-gray-700 text-sm px-4 py-2.5 pr-8 rounded-lg shadow-sm outline-none cursor-pointer transition-all duration-150 hover:border-gray-400 focus:border-gray-500 focus:ring-2 focus:ring-gray-200";

  return (
    <div className="flex flex-wrap gap-3 items-center p-4 bg-white border border-gray-200 rounded-xl shadow-sm mb-4">
      {/* Category */}
