import { Cart } from '@/src/modules/carts/schemas/carts.schema';

export const cartFakeDataRequest: Cart = {
  info: {
  ...
  classification: [
    {
      name: 'Màu sắc',
      values: [
        { name: 'Trắng', extraPrice: 0, stock: 100, img: '', choosen: true },
        { name: 'Đen', extraPrice: 0, stock: 100, img: '', choosen: false },
        { name: 'Cam', extraPrice: 0, stock: 100, img: '', choosen: false },
        { name: 'Vàng', extraPrice: 0, stock: 100, img: '', choosen: false },
      ],
    },
    {
      name: 'Dung lượng bộ nhớ',
      values: [
        { name: '256GB', extraPrice: 0, stock: 100, img: '', choosen: false },
        {
          name: '512GB',
          extraPrice: 10000000,
          stock: 100,
